...
# ================================================================
# CLASE DS3231 (Driver mínimo para RTC DS3231)
# ================================================================
class DS3231:
    """Driver simple para el RTC DS3231 vía I2C."""
...
# ================================================================
# CLASE CTIEMPO (Orquestador principal)
# ================================================================
class CTiempo:
    """
    Orquestador de tiempo y notificaciones usando DS3231.
    """
    ...
    def procesar_tick(self):
        ...
        # Notificar tick a todos los listeners
    ...
    def set_datetime(self, year, month, day, hour, minute, second):
        """Método cómodo para configurar el RTC."""
